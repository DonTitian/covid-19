...
class SEResNeXt(object):
    def __init__(self, input_size, num_classes=2, depth=16, reduction_ratio=4, num_split=4, num_block=3):
        ...
        if K.image_data_format() == 'channels_first':
            ...
            self.channel_axis = 3
        self.model = self.build_model(Input(shape=input_size), num_classes)
